...
@section('content-admin')
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 mt-1" style="color:#002455; font-size: 0.9rem;">
                                        Gunakan nama yang jelas dan mudah dipahami untuk membantu pelanggan menemukan produk
                                        dengan cepat.
                                    </p>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('admin.category.store') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="name" name="name"
                                        value="{{ old('name') }}" placeholder="Contoh: Elektronik, Fashion, Makanan"
                                        style="border: 2px solid #e9ecef; border-left: none; border-radius: 0 10px 10px 0; padding: 0.75rem;"autofocus>
                                </div>
                            ...
                            <div class="mb-4 p-3"
                                ...
                                <div class="progress mt-2"
                                    style="height: 6px; background-color: #e9ecef; border-radius: 3px;">
                                    <div class="progress-bar" id="charProgress" role="progressbar"
                                        style="width: 0%; background: linear-gradient(90deg, #002455 0%, #1B3C53 100%); border-radius: 3px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 mb-3">
                                ...
                                <a href="{{ route('admin.category') }}" class="btn btn-cancel"
    ...
    <script>
        ...
        const maxChars = 100; // Sesuai dengan controller (max:100)
