...
@section('content-admin')
                    ...
                    <div class="card-body p-4" style="padding-top: 2.5rem !important;">
                            ...
                            <div class="mb-4 p-3"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span id="charCount" class="badge px-3 py-2"
                                        ...
                                        {{ strlen($category->name) }} / 100
                                    </span>
                                </div>
                                <div class="progress mt-2"
                                    style="height: 6px; background-color: #e9ecef; border-radius: 3px;">
                                    <div class="progress-bar" id="charProgress" role="progressbar"
                                        style="width: {{ (strlen($category->name) / 100) * 100 }}%; background: linear-gradient(90deg, #002455 0%, #1B3C53 100%); border-radius: 3px;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-4 pt-3" style="border-top: 2px dashed #e9ecef;">
                            ...
                            <form action="{{ route('admin.category.destroy', $category->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-sm" onclick="confirmDelete()"
    ...
    <script>
        ...
        const maxChars = 100; // Sesuai dengan controller
