...
@section('content-admin')
    <div class="container-fluid">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; border-left: 4px solid #002455 !important;">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <button class="btn btn-sm" 
                                style="background-color: transparent; color:#002455; border: 2px solid #002455; border-radius: 8px; padding: 0.5rem 1rem; font-weight: 600;">
                        ...
                        <table class="table table-hover mb-0">
                            <thead style="background-color: #f8f9fa;">
                                <tr>
                                    ...
                                    <th class="border-0 px-4 py-3" style="color:#002455; font-weight: 600; width: 150px;">
                                        <i class="fas fa-box me-2" style="color:#FFC107;"></i>Produk
                                    </th>
                                    <th class="border-0 px-4 py-3 text-end" style="color:#002455; font-weight: 600; width: 200px;">
                                    ...
                                    <tr class="category-row" style="transition: all 0.3s ease;">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="fw-semibold category-name" style="color:#002455; font-size: 1.05rem;">
                                                        {{ $item->name }}
                                                    </span>
                                                    <br>
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="badge px-3 py-2" 
                                                  style="background-color: rgba(0,36,85,0.1); color:#002455; border-radius: 8px; font-weight: 600; font-size: 0.875rem;">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 16px; border: none;">
                <div class="modal-header border-0" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); border-radius: 16px 16px 0 0;">
