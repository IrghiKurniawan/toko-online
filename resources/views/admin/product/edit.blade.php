                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control border-start-0" id="price"
                                                    name="price" value="{{ old('price', $products->price) }}"
                                                    placeholder="0"
                                                    style="border: 2px solid #e9ecef; border-left: none; border-radius: 0 10px 10px 0; padding: 0.75rem;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="stock" class="form-label fw-semibold mb-2"
                                                style="color:#002455;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control border-start-0" id="stock"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div id="imageWrapper" class="mb-3 {{ $products->image ? '' : 'd-none' }}"
                                        ...
                                        {{-- Upload Button --}}
                                        <label for="imageInput" class="btn w-100 upload-btn"
                                            ...
                                            <small class="d-block mt-2 text-muted">JPG, PNG, atau WEBP (Max 5MB)</small>
                                        </label>
                                        <input type="file" class="d-none" name="image" id="imageInput"
                                            accept="image/*">
