                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0" style="color:#002455;">{{ $products->pluck('category_id')->unique()->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h4 class="fw-bold mb-0" style="color:#002455;">{{ $products->where('stock', 0)->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
