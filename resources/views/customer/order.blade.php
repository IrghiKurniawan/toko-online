        ...
        <div class="order-card card border-0 shadow-sm mb-4"
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button class="btn btn-sm toggle-items"
                            ...
                            <div class="order-item-row d-flex justify-content-between align-items-center mb-2 pb-2"
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    <div class="item-bullet me-3"
                                         style="width: 8px; height: 8px; background-color: #FFC107; border-radius: 50%;"></div>
                                    <div>
                                ...
                                <div class="text-end">
                                    <span class="badge px-3 py-2"
                                        ...
                                        <i class="fas fa-times me-1" style="font-size: 0.75rem;"></i>{{ $item->quantity }}
                                    </span>
                                    <div class="mt-1">
                    ...
                    <div class="order-summary mt-3 p-3"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2 mb-md-0">
                                ...
                                <span class="badge px-3 py-2"
                                      style="background: linear-gradient(135deg, #002455 0%, #1B3C53 100%); color:#fff; border-radius: 8px;">
        ...
        <div class="empty-state text-center py-5">
            <div class="card border-0 shadow-sm"
                ...
                <div class="card-body p-5">
                    ...
                    <a href="{{ route('customer.index') }}" class="btn px-5 py-3"
