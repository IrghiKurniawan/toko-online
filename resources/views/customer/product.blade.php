            ...
            <form action="" method="GET" class="d-flex" style="max-width:450px; width:100%;">
                ...
                <div class="ms-2">
                    <a href="{{ route('customer.cart') }}"
                        ...
                        style="background-color:#FFC107; color:#002455; border: 2px solid #FFC107;">
                            ...
                            <div class="position-relative overflow-hidden"
                                ...
                                <div class="position-absolute bottom-0 start-0 end-0 p-2 quick-view-overlay"
                                    ...
                                    <button class="btn btn-sm w-100"
                                        style="background-color:#fff; color:#002455; font-weight: 600;">
                                ...
                                <div class="mt-auto">
                                    @if ($product->stock > 0)
                                        <a href="{{ route('customer.cart.add', $product->id) }}"
                                            class="btn w-100 add-to-cart-btn"
