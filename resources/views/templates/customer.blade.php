...
<body>
    @if (auth()->check())
        <nav class="navbar navbar-expand-lg custom-navbar">
            <div class="container">
                {{-- Brand --}}
                <a class="navbar-brand" href="{{ route('customer.product') }}">
                    <div class="brand-icon">
                        <i class="fas fa-store"></i>
                    </div>
                    <span>Toko Elektronik</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        {{-- Produk --}}
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('customer.product*') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('customer.order*') ? 'active' : '' }}"
                                ...
                                <i class="fas fa-receipt me-2"></i>History Order
                            </a>
                        </li>
